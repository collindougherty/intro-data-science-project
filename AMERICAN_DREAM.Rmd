...
```{r, figure8, echo=FALSE, message=FALSE,warning=FALSE,fig.cap="Real median household wealth over time for different ages"}
...
```{r, figure9, echo=FALSE, message=FALSE, fig.cap="Real Median Income, US"}
...
```{r, figure10, echo=FALSE, message=FALSE, fig.cap="Median Income, US"}
...
```{r, figure12, echo=FALSE, message=FALSE, fig.cap="Share of Net Worth by Economic Class"}
...
```{r, figure13, echo=FALSE, message=FALSE, fig.cap="Share of Consumer Credit by Economic Class"}
...
```{r, figure14, echo=FALSE, message=FALSE, fig.cap="Share of Mortgages by Economic Class"}
...
```{r, figure15, echo=FALSE, message=FALSE, fig.cap="Share of Assets by Economic Class"}
