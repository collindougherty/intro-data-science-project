...
income = fread('./americandream/tableA2.csv')
...
combinedNetworthByRace <- read_excel("./americandream/CombinedNetByRace.xlsx",
...
```{r, figure5, echo=FALSE, message=FALSE, fig.cap="Real Median Income, US"}
real_median_income <- read.csv('MEHOINUSA672N.csv')
median_income <- read.csv('MEFAINUSA646N.csv')
income_lowest_50 <- read.csv('WFRBLB50107.csv')
income_share <- read.csv('dfa-networth-shares.csv')
...
```{r, figure6, echo=FALSE, message=FALSE, fig.cap="Share of Net Worth by Economic Class"}
...
```{r, figure7, echo=FALSE, message=FALSE, fig.cap="Share of Consumer Credit by Economic Class"}
...
```{r, figure8, echo=FALSE, message=FALSE, fig.cap="Share of Mortgages by Economic Class"}
income_share_summed1 <- aggregate(Home.mortgages ~ Date + Category, data = income_share, sum)
# Create a ggplot object with Bottom50 net worth over time
ggplot(income_share_summed1, aes(x = Date, y = Home.mortgages, color = Category)) +
  geom_line() +
  labs(x = "Date", y = "Percentage", title = "Share of Mortgages by Economic Class") +
  theme_minimal()
```

```{r, figure9, echo=FALSE, message=FALSE, fig.cap="Share of Assets by Economic Class"}
