...
\begin{enumerate}
\item Understanding social mobility: Exploring the concept of upward mobility helps us understand how social mobility works in society. It allows us to examine the factors that contribute to success, including education, hard work, and access to resources. 
\item Encouraging aspiration: Examining the American Dream and upward mobility can also inspire people to pursue their goals and dreams. By seeing examples of success and learning about the factors that contribute to it, people can be encouraged to work hard and strive for their own upward mobility. 
\end{enumerate}
...
combinedNetByEd <- read_excel("CombinedNetByEd.xlsx",col_names = TRUE, skip = 1)
