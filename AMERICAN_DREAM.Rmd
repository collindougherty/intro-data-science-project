...
````{r, figure5, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Per capita personal in the United States from 2000 to 2021"}
...
```{r, Figure7, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Assets by wealth percentile group in 2022"}
...
```{r, figure7, echo=FALSE, message=FALSE, fig.cap="Share of Net Worth by Economic Class"}
