...
wealthByRace_chart <- ggplot(combinedNetByRace_wide, aes(x = year, 
 ...
 geom_line() + labs(x = "Year", y = "Median Net Worth", 
...
```{r, figure5, echo=FALSE, message=FALSE, fig.cap="Average sales price of houses sold for the United States"}
...
```{r, figure6, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Per capita personal in the United States from 2000 to 2021"}
...
```{r, Figure7, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Wealth Estimates from across the United States in 2022"}
...
```{r, Figure8, echo=FALSE, message=FALSE, fig.cap="Assets by wealth percentile group in 2022"}
...
```{r, figure9, echo=FALSE, message=FALSE,warning=FALSE,fig.cap="Real median household wealth over time for different ages"}
...
```{r, figure10, echo=FALSE, message=FALSE, fig.cap="Real Median Income, US"}
...
```{r, figure12, echo=FALSE, message=FALSE, fig.cap="Real Median Income, US"}
...
```{r, figure14, echo=FALSE, message=FALSE, fig.cap="Share of Consumer Credit by Economic Class"}
...
```{r, figure15, echo=FALSE, message=FALSE, fig.cap="Share of Mortgages by Economic Class"}
...
```{r, figure16, echo=FALSE, message=FALSE, fig.cap="Share of Assets by Economic Class"}
